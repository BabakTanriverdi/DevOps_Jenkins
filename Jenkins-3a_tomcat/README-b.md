...
Purpose of the this hands-on training is to learn how to deploy applications to the Staging/Production Environment with Jenkins.
...
- NOTE: your jenkins instance needs to have mvn as well and note that it wont get installed with any plugins if you already have it installed
...
- Build Steps:
    Copy artifact from another project: # if you dont havve the plugin install it 
